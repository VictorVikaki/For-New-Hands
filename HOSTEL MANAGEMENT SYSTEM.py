...
def main():
            ...
            def student():
                ...
                if b == bed1:
                    for oneline in fdata_ls:
                        if oneline.startswith(rom + ",") and oneline._contains_(","+bed1):
                            # write date
                    ...
                    if b == bed2:
                        for oneline in fdata_ls:
                            if oneline.startswith(rom + ",") and oneline._contains_(","+bed2):
                                # write date
                        ...
                        for oneline in fdata_ls:
                            if oneline.startswith(rom + ",") and oneline._contains_(","+bed3):
                                # write date
    ...
    def in_out_time():
        ...
        def search_outtime():
            ...
            count = 1
            for oneline in fdata_ls:
                if oneline.startswith(s_id + ",") and oneline._contains_(",OUTTIME,"):
                    # write date
                    count = 2
                    y = oneline.split(",")
                    tv = StringVar()
